...
int main(){
	...
	std::vector<vertex> vertex_data={
	    ...
	    vertex{glm::vec3{-0.5f, -0.5f, 0.5f}, glm::vec3{0.0f, -1.0f, 0.0f}, glm::vec2{0.0f, 1.0f}},
	    vertex{glm::vec3{0.5f, -0.5f, 0.5f}, glm::vec3{0.0f, -1.0f, 0.0f}, glm::vec2{1.0f, 1.0f}},
	    vertex{glm::vec3{0.5f, -0.5f, -0.5f}, glm::vec3{0.0f, -1.0f, 0.0f}, glm::vec2{1.0f, 0.0}}
	};
	// index buffer
	std::vector<face> faces = {
	    face{{0, 1, 2}}, face{{0, 3, 2}}, face{{4, 5, 6}}, face{{4, 7, 6}}, face{{8, 9, 10}}, face{{8, 11, 10}}, face{{12, 13, 14}}, face{{12, 15, 14}}, face{{16, 17, 18}}, face{{16, 19, 18}}, face{{20, 21, 22}}, face{{20, 23, 22}}
	};
	gl_texture t1, t2;
	t1.loadData("/home/hungvu/Archive/progs/opengl/texture/box.png", aiTextureType_DIFFUSE);
	t2.loadData("/home/hungvu/Archive/progs/opengl/texture/steel_frame.png", aiTextureType_SPECULAR);
	std::vector<gl_texture> tex = {
		t1, t2
	};
	model_obj.meshes.push_back(glw_model::glw_mesh{vertex_data, faces, tex});
